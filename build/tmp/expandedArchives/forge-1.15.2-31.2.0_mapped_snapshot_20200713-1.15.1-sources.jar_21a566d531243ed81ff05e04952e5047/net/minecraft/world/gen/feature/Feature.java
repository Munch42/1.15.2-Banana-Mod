...
public abstract class Feature<FC extends IFeatureConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Feature<?>> {
   ...
   public static final Feature<TreeFeatureConfig> NORMAL_TREE = register("normal_tree", new TreeFeature(TreeFeatureConfig::deserializeFoliage));
   ...
   public static final Feature<TreeFeatureConfig> FANCY_TREE = register("fancy_tree", new FancyTreeFeature(TreeFeatureConfig::deserializeFoliage));
   ...
   public static List<Structure<?>> ILLAGER_STRUCTURES = ImmutableList.of(PILLAGER_OUTPOST, VILLAGE);
   ...
   public ConfiguredFeature<FC, ?> withConfiguration(FC configIn) {
      return new ConfiguredFeature<>(this, configIn);
   }
