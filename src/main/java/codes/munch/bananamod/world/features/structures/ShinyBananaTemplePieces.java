package codes.munch.bananamod.world.features.structures;
 ...
 *
 *  FROM https://github.com/TelepathicGrunt/StructureTutorialMod
 * Most Comments came from ^ too
 */
public class ShinyBananaTemplePieces {
    /*
     ...
     *
     * Move the nbt file of your structure into data.mod_id.structures folder under src/main/resources in your mod. Make
     ...
     */
    private static final ResourceLocation MAIN_PIECE = new ResourceLocation(BananaMod.MOD_ID + ":shiny_banana_temple");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(MAIN_PIECE, new BlockPos(0, 1, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random){
        ...
        pieceList.add(new ShinyBananaTemplePieces.Piece(templateManager, MAIN_PIECE, blockpos, rotation));
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        {
            super(FeatureInit.SBTP, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = ShinyBananaTemplePieces.OFFSET.get(resourceLocation);
        ...
        {
            super(FeatureInit.SBTP, tagCompound);
        ...
        {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            BlockPos blockpos = ShinyBananaTemplePieces.OFFSET.get(this.resourceLocation);
